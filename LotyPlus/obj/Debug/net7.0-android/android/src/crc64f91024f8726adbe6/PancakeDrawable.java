...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Maui.PancakeView.Droid.PancakeDrawable, PancakeViewCompat", PancakeDrawable.class, __md_methods);
	}
	...
	public PancakeDrawable ()
	{
		...
		if (getClass () == PancakeDrawable.class) {
			mono.android.TypeManager.Activate ("Maui.PancakeView.Droid.PancakeDrawable, PancakeViewCompat", "", this, new java.lang.Object[] {  });
		}
	}
